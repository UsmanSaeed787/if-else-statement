...
var marksInFsc = 903;
var totalMarks = 1100;
var percent = Math.floor((marksInFsc / totalMarks) * 100);
...
if (weeks > 0 && remainingDays > 0) {
    result = `${weeks} week${weeks > 1 ? "s" : ""} and ${remainingDays} day${remainingDays > 1 ? "s" : ""}`;
}
else if (weeks > 0) {
...
var priceOfProduct = 100;
if (priceOfProduct > 100) {
    var discountApplied1 = priceOfProduct - priceOfProduct * 0.1;
    console.log(`Your discounted price is ${discountApplied1}`);
}
else {
    var discountApplied2 = priceOfProduct - priceOfProduct * 0.05;
