...
var tmpToCel: number = 37;
var tmpToFar: number = tmpToCel * (9 / 5) + 32;
console.log(tmpToFar);

// --------------------------------------------------------------------------------------------------

// 2 - Write a program that calculates the percentage.

var Fscmarks: number = 949;
var TotalMarks: number = 1100;
var percent: number = Math.floor((Fscmarks / TotalMarks) * 100);
console.log(`Percentage of FSC marks is ${percent}%`);
